...
class FilesUtil(Application):
    ...
    def search_for_files(self, file_filter, sort_order=SortOrder.DEFAULT, ascending=False, offset=0, limit=100):

        self.invoke('searchForFiles', file_filter, sort_order, ascending, limit, offset)