...
class DataImporter(object):
    ...
    * ``s3://``
    ...
    def __init__(self, connection):
        ...
        self.importer = connection.application('genestack/importer')
    ...
    def __invoke_loader(self, method, parent, metainfo):
        self.__process_links(metainfo)
        return self.importer.invoke(method, parent, metainfo)['accession']
    ...
    def create_bed(self, parent=None, name=None, reference_genome=None, url=None, metainfo=None):
        ...
        return self.__invoke_loader('createBED', parent, metainfo)
    ...
    def create_vcf(self, parent=None, name=None, reference_genome=None, url=None, metainfo=None):
        ...
        reference_genome and metainfo.add_file_reference(BioMetainfo.REFERENCE_GENOME, reference_genome)
        url and metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createVariation', parent, metainfo)
    ...
    def create_wig(self, parent=None, name=None, reference_genome=None, url=None, metainfo=None):
        ...
        reference_genome and metainfo.add_file_reference(BioMetainfo.REFERENCE_GENOME, reference_genome)
        url and metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createWIG', parent, metainfo)
    ...
    def create_bam(self,
        ...
        return self.__invoke_loader('createBAM', parent, metainfo)
    ...
    def create_experiment(self, parent=None, name=None, description=None, metainfo=None):
        ...
        return self.__invoke_loader('createExperiment', parent, metainfo)
    ...
    def create_microarray_assay(self, parent, name=None, urls=None,
        ...
        return self.__invoke_loader('createMicroarrayAssay', parent, metainfo)
    ...
    def create_sequencing_assay(self, parent, name=None, urls=None,
        ...
        return self.__invoke_loader('createSequencingAssay', parent, metainfo)
    ...
    def create_unaligned_read(self, parent=None, name=None, urls=None,
        ...
        if urls:
            for url in urls:
                metainfo.add_external_link(BioMetainfo.READS_LINK, url)
        return self.__invoke_loader('createUnalignedReads', parent, metainfo)
    ...
    def create_genome_annotation(self, parent=None, url=None, name=None,
        ...
        if url:
            metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createGOAnnotation', parent, metainfo)

    def create_codon_table(self, parent=None, metainfo=None):
        metainfo = metainfo or BioMetainfo()
        return self.__invoke_loader('createCodonTable', parent, metainfo)
    ...
    def create_dbnsfp(self, parent=None, url=None, name=None, organism=None, metainfo=None):
        ...
        if url:
            metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createDbNSFP', parent, metainfo)
    ...
    def create_reference_genome(self,
        ...
        return self.__invoke_loader('createReferenceGenome', parent, metainfo)
    ...
    def create_report_file(self, parent=None, name=None, urls=None, metainfo=None):
        ...
        if urls:
            for url in urls:
                metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('importReport', parent, metainfo)
    ...
    def create_mapped_reads_count(self,
        ...
        reference_genome and metainfo.add_file_reference(BioMetainfo.REFERENCE_GENOME, reference_genome)
        url and metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createMappedReadsCount', parent, metainfo)
    ...
    def create_owl_ontology(self, parent=None, name=None, url=None, metainfo=None):
        ...
        name and metainfo.add_string(BioMetainfo.NAME, name)
        url and metainfo.add_external_link(BioMetainfo.DATA_LINK, url)
        return self.__invoke_loader('createOwlOntology', parent, metainfo)
