...
project = 'Genestack Python Client Library'
copyright = '2020, Genestack'
...
latex_documents = [
  ('index', 'python_client_library.tex', 'Genestack Python Client Library Documentation',
   'Genestack Limited', 'manual'),
]
...
man_pages = [
    ('index', 'python_client_library', 'Genestack Python Client Library Documentation',
     ['Genestack Limited'], 1)
]
...
texinfo_documents = [
  ('index', 'python_client_library', 'Genestack Python Client Library Documentation',
   'Genestack Limited', 'genestack-python-client-library', 'Genestack Python Client Library Documentation',
   'Miscellaneous'),
]
...
epub_title = 'Genestack Python Client Library Documentation'
epub_author = 'Genestack Limited'
epub_publisher = 'Genestack Limited'
epub_copyright = '2017, Genestack Limited'
