...
def upload_disease():
    ...
    disease_ontology = {
        ...
        'description': 'Classification of human diseases by etiology. Domain: Diseases / Human Health, Version: 2025-05-30. The original data is available via the link http://purl.obolibrary.org/obo/doid/releases/2025-05-30/doid.owl'
    }
    ...
    disease_ontology_extended = {
        ...
        'description': 'Classification of human diseases by etiology enriched by term "Healthy" and its synonyms. Domain: Diseases / Human Health, Version: 2025-05-30, extended by term "Healthy". The original data is available via the link http://purl.obolibrary.org/obo/doid/releases/2025-05-30/doid.owl'
    }
...
def upload_gene_ontology():
    ...
    gene_ontology = {
        ...
        "description": "Describes gene functions: biological process, molecular function, cellular component. Domain: Molecular Function / Biological Process, Version: 2024-11-03. The original data is available via the link http://purl.obolibrary.org/obo/go/releases/2024-11-03/extensions/go-plus.owl"
    }
